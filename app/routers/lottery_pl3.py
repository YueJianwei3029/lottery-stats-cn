...
from app.services.pos_stats import (
    ...
    ratio_stats, period_list_stats, type_analysis_stats,
)
...
@router.get("/stats/type_analysis")
def ext_type_analysis(date: str = Query(default=None), end_date: str = Query(default=None)):
    return {"code": 200, "message": "success",
            "data": type_analysis_stats(date=date, end_date=end_date)}
